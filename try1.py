...
search = CTkEntry(frame, font=("Helvetica", 18), placeholder_text='SEARCH')
...
search_button = CTkButton(frame, text='', image=search_icon, command=search_click, corner_radius=0)
search_button.grid(row=0, column=1, sticky="ew")

# Configure the grid to make the search entry expand
frame.columnconfigure(0, weight=1)
frame.columnconfigure(1, weight=0)

# Create a label to display the weather information
result_label = CTkLabel(app, text="", font=("Bauhaus 93", 56), wraplength=280, justify="center")
